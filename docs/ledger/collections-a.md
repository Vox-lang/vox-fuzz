...
| LST-43 | 2548 | `Set map's "key" to value` inserts a new entry or replaces an existing one. | emit both a replace and an insert, assert value and `length` after each | yes | `gen leaf map insert and replace` | **verified** | leaf assertion, campaign 2026-09-05 (seed 20260905, 200 programs, budget 12): fired 78/200 |
...
| LST-45 | 2555–2558 | Worked example: after `set person's "age" to 37`, `length` is still 2 — a replace, not an insert. | reproduce, assert `length` | yes | `gen leaf map insert and replace` | **verified** | leaf assertion, campaign 2026-09-05 (seed 20260905, 200 programs, budget 12): fired 78/200 |
| LST-46 | 2561 | `length` is the live entry count and `empty` is true only at zero entries, as for lists. | assert `length` and `empty` on a populated and an empty map | yes | `gen leaf map length and empty` | **verified** | leaf assertion, campaign 2026-09-05 (seed 20260905, 200 programs, budget 12): fired 36/200 |
...
| LST-62 | 2642 | The type nouns are `number`, `text`, `decimal`, `boolean`, `list`, `map`. | emit all six against a list holding one of each, assert each match | yes | `gen leaf predicate all six match` | **verified** | leaf assertion, campaign 2026-09-05 (seed 20260905, 200 programs, budget 12): fired 144/200 |
| LST-63 | 2642–2643 | The declaration synonyms also work as predicate nouns: `integer`→number, `string`→text, `float`/`real`→decimal, `bool`→boolean, `dictionary`→map. | emit each synonym, assert it matches the same slot its canonical noun does | yes | `gen leaf predicate synonyms` | **verified** | leaf assertion, campaign 2026-09-05 (seed 20260905, 200 programs, budget 12): fired 165/200 |
| LST-64 | 2644–2649 | Negate with `is not a`. | emit the negated form, assert the branch | yes | `gen leaf predicate negate` | **verified** | leaf assertion, campaign 2026-09-05 (seed 20260905, 200 programs, budget 12): fired 142/200 |

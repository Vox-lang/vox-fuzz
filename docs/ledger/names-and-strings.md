...
Source: `../vox/LANGUAGE.md` lines 715–731, Vox 0.4.10 (5545 lines, vox
...
"Naming Rules" table (LANGUAGE.md:682–711) — but that table is *inside*
...
LANGUAGE.md:724–725 claims the worked example `a number called "x" is

...
Source: `../vox/LANGUAGE.md` lines 708–724, Vox 0.4.10 (5545 lines, vox
...
"Naming Rules" table (LANGUAGE.md:675–704) — but that table is *inside*
...
LANGUAGE.md:717–718 claims the worked example `a number called "x" is

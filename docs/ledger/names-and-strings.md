...
Source: `../vox/LANGUAGE.md` lines 692–708, Vox 0.4.10 (5545 lines, vox
...
"Naming Rules" table (LANGUAGE.md:659–688) — but that table is *inside*
...
LANGUAGE.md:701–702 claims the worked example `a number called "x" is

...
| THG-14 | 979–981 | **Claim widened, 2026-08-29 (0.4.15, #110) — was "bare word or quoted multi-word name", now explicitly allows a single-quoted single word too, the same forms any identifier takes.** A thing name may be a bare word, or any name in single quotes (a single word may be quoted too) — `point`, `'bounding box'`. | define and declare a `'bounding box'`-style type, and separately a single-quoted single-word type name (2+ characters — LANGUAGE.md:696–699 excludes one-character quotes, they lex as a char literal) | yes | none — the prelude's four types are `t1`–`t4`, bare words every time. Neither quoted-type-name path is ever taken by any generated program. | todo — real gap, and an unjustified invariant today (see below); the single-word quoted form is also the #110 fix, new row added 2026-08-29 | |

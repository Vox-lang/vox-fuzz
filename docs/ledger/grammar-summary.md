...
Source: `../vox/LANGUAGE.md` lines 5542–5608, Vox 0.4.10 (5545 lines, vox
...
LANGUAGE.md:5555–5556, **before** 0.4.10:
...
itself was corrected too.** LANGUAGE.md:5555–5556 now reads:
...
- byte-for-byte, the article before a type keyword is always `a` or `an`, never a bare type name — LANGUAGE.md:5550, GRM-03 (cross-ref VAR-01)
- a function call's connector is always one of exactly `of`/`with`/`to`/`on`, never a bare juxtaposition or another preposition — LANGUAGE.md:5562, GRM-08 (cross-ref FUN-32)

...
Source: `../vox/LANGUAGE.md` lines 5690–5756, Vox 0.4.10 (5545 lines, vox
...
grouping punctuation (LANGUAGE.md:1933, 1939), is not listed as a
...
LANGUAGE.md:5703–5704, **before** 0.4.10:
...
itself was corrected too.** LANGUAGE.md:5703–5704 now reads:
...
- byte-for-byte, the article before a type keyword is always `a` or `an`, never a bare type name — LANGUAGE.md:5698, GRM-03 (cross-ref VAR-01)
- a function call's connector is always one of exactly `of`/`with`/`to`/`on`, never a bare juxtaposition or another preposition — LANGUAGE.md:5710, GRM-08 (cross-ref FUN-32)

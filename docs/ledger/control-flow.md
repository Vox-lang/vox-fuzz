...
LANGUAGE.md:2355–2357 gives `Increment the counter.` / `Decrement the
...
LANGUAGE.md:2261–2262 introduces the loop variable under the heading
...
- `then,` follows every `If`/`When` condition — LANGUAGE.md:2192, FLW-01
- a comma follows every loop head (`While <cond>,`, `For each … ,`,
  `Repeat <count> times,`) — LANGUAGE.md:2224/2097/2124, FLW-11/15/23
- `times` follows every `Repeat` count — LANGUAGE.md:2282, FLW-23
- `Break`/`Continue` never appear outside a loop — FLW-33 (compile error;
  undocumented but hard-enforced)
- `Exit`'s code, when present, is a number — LANGUAGE.md:2334, FLW-34

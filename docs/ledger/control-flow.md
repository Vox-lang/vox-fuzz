...
LANGUAGE.md:2356–2358 gives `Increment the counter.` / `Decrement the
...
LANGUAGE.md:2262–2263 introduces the loop variable under the heading
...
- `then,` follows every `If`/`When` condition — LANGUAGE.md:2193, FLW-01
- a comma follows every loop head (`While <cond>,`, `For each … ,`,
  `Repeat <count> times,`) — LANGUAGE.md:2225/2097/2124, FLW-11/15/23
- `times` follows every `Repeat` count — LANGUAGE.md:2283, FLW-23
- `Break`/`Continue` never appear outside a loop — FLW-33 (compile error;
  undocumented but hard-enforced)
- `Exit`'s code, when present, is a number — LANGUAGE.md:2335, FLW-34

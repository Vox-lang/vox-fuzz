...
Manual version pinned here: **Vox 0.4.10** (`../vox/LANGUAGE.md`, 5603
...
| VAL | `values.md` | 2666–2915 | Dynamic values (`value`) and `nothing` | **yes** | 32 | 1 | 0 | 0 open — **D1 RESOLVED, vox #43** (conditional `value` return used to segfault); **D2 RESOLVED** (manual corrected, no compiler change needed) | |

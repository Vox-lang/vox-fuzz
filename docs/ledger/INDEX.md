...
Manual version pinned here: **Vox 0.4.10** (`../vox/LANGUAGE.md`, 5587
lines, vox `527cb89`), re-pinned 2026-08-23 (previously `b557ae5`,
5611 lines — the spec diet moved the history and the "Design notes for
review" out of LANGUAGE.md into `docs/HISTORY.md` and dropped four
`(v0.1.x)` heading suffixes; PR #211 re-spelled four example
annotations). When the manual moves, re-pin the line ranges in

...
| VAL | `values.md` | 2671–2920 | Dynamic values (`value`) and `nothing` | **yes** | 32 | 0 | 15 | 0 open — **D1 RESOLVED, vox #43** (conditional `value` return used to segfault); **D2 RESOLVED** (manual corrected, no compiler change needed) | |

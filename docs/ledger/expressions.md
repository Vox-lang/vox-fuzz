...
| EXP-10 | 1922 | Arithmetic operates on numbers; booleans count as 0/1. | emit a boolean in an arithmetic operand position and assert 1 / 0 | yes — `If upvote is not 1 then, Exit 95.` | `gen leaf boolean arithmetic` | **verified** | leaf assertion, campaign 2026-09-05 (seed 20260905, 200 programs, budget 12): fired 42/200 |
...
| EXP-14 | 1925 | `0xFF` equals 255. | assert the value of a hex literal | yes — `If mask is not 255 then, Exit 95.` | `gen leaf hex literal` | **verified** | leaf assertion, campaign 2026-09-05 (seed 20260905, 200 programs, budget 12): fired 35/200 |
| EXP-15 | 1926 | `0b1010` equals 10. | assert the value of a binary literal | yes | `gen leaf binary literal` | **verified** | leaf assertion, campaign 2026-09-05 (seed 20260905, 200 programs, budget 12): fired 35/200 |
| EXP-16 | 1927 | `'A'` equals 65. | assert the value of a character literal | yes | `gen leaf character literal` | **verified** | leaf assertion, campaign 2026-09-05 (seed 20260905, 200 programs, budget 12): fired 30/200 |
...
| EXP-18 | 1932 | `the number` references the loop iterator inside `for each`. | emit `the number` inside a range loop | yes — sum the iterations and assert the total | `gen leaf article the number iterator` | **verified** | leaf assertion, campaign 2026-09-05 (seed 20260905, 200 programs, budget 12): fired 16/200 |
...
| EXP-29 | 1950, 2174 | A cast binds tighter than arithmetic and applies to the expression immediately to its left. | emit `a add b as a number` where the two readings differ, and assert the tight one | yes — `3.5 add {2.5 as a number}` is 5.5; the loose reading would be 6 | `gen leaf cast tight and braced` | **verified** | leaf assertion, campaign 2026-09-05 (seed 20260905, 200 programs, budget 12): fired 19/200 |
| EXP-30 | 1950, 2174 | Bracing casts a whole arithmetic expression: `{a add b} as a number`. | emit a braced expression followed by a cast | yes — `{3.5 add 2.5} as a number` is 6 | `gen leaf cast tight and braced` | **verified** | leaf assertion, campaign 2026-09-05 (seed 20260905, 200 programs, budget 12): fired 19/200 |
...
| EXP-35 | 1959 | `x is 0` — a bare value on the right is an equality comparison. | emit `<var> is <literal>` as a condition | yes | `gen leaf bare zero comparison` | **verified** | leaf assertion, campaign 2026-09-05 (seed 20260905, 200 programs, budget 12): fired 10/200 |
...
| EXP-39 | 1968 | `x is odd` is true iff x is odd. | as above | yes | `gen leaf odd and negative predicates` | **verified** | leaf assertion, campaign 2026-09-05 (seed 20260905, 200 programs, budget 12): fired 7/200 |
...
| EXP-41 | 1970 | `x is negative` is true iff x < 0. | as above | yes | `gen leaf odd and negative predicates` | **verified** | leaf assertion, campaign 2026-09-05 (seed 20260905, 200 programs, budget 12): fired 7/200 |
| EXP-42 | 1971 | `x is zero` is true iff x = 0. | as above | yes | `gen leaf predicate probe` (`gen_misc.vox:435`) | exercised | |
| EXP-43 | 1972 | `<list> is empty` is true iff the list has no elements. | emit `is empty` on a **list**, full and empty | yes — the generator built the list | `gen leaf list emptiness check` | **verified** | leaf assertion, campaign 2026-09-05 (seed 20260905, 200 programs, budget 12): fired 11/200 |
...
| EXP-51 | 2009–2014 | `if x, y, and z are true` expands to `if x is true and y is true and z is true`. | emit both forms on the same subjects and assert they agree | yes — hand-verified to agree on all four combinations tried | `gen leaf plural are expansion` | **verified** | leaf assertion, campaign 2026-09-05 (seed 20260905, 200 programs, budget 12): fired 14/200 |
...
| EXP-83 | 2116–2118 | Parsing stops at the first character invalid for the base: `"12g5" as a hex number` gives 18. | emit a string with a valid prefix and an invalid tail, assert the prefix's value | yes — the generator chose both halves | `gen leaf base conversion partial and total parse` | **verified** | leaf assertion, campaign 2026-09-05 (seed 20260905, 200 programs, budget 12): fired 20/200 |
| EXP-84 | 2118–2120 | A string invalid from its very first character gives 0 (`"abc" as a base5 number`). | emit such a string, assert 0 | yes | `gen leaf base conversion partial and total parse` | **verified** | leaf assertion, campaign 2026-09-05 (seed 20260905, 200 programs, budget 12): fired 20/200 |
...
| EXP-94 | 2187 | To round, add 0.5 before casting: `{3.7 add 0.5} as a number` gives 4. | emit the idiom and assert | yes — hand-verified: 3.7 gives 4, 3.2 gives 3, so it really rounds | `gen leaf round half up` | **verified** | leaf assertion, campaign 2026-09-05 (seed 20260905, 200 programs, budget 12): fired 8/200 |
...
| EXP-98 | 2193 | Zero is `false`; any non-zero number is `true`. | emit a number in condition position and assert which branch runs | yes | `gen leaf bare number condition` | **verified** | leaf assertion, campaign 2026-09-05 (seed 20260905, 200 programs, budget 12): fired 14/200 |

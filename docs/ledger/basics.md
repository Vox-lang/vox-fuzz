...
LANGUAGE.md:39, the first sentence of the section: "Every statement ends
...
LANGUAGE.md:136 (rule 2): "A blank line (paragraph break) force-closes
**every open clause at once** — including an enclosing function
definition." LANGUAGE.md:88: a function definition "is closed by a blank
line (paragraph break) — this is *required*". LANGUAGE.md:211: "An
...
LANGUAGE.md:53–74 documents comments, multi-line comments and nested
...
LANGUAGE.md:88's comparable "construct still open at end of file" case —
...
| no program contains stacked periods (`..`) | LANGUAGE.md:194 documents them — BAS-40/BAS-47 |
| no program contains `Otherwise,.` | LANGUAGE.md:241 documents it — BAS-54 |
| no `On error` handler has more than one action; no `If`/`Otherwise` branch has more than one action | LANGUAGE.md:105, 108 show both with two — BAS-30/BAS-31 |
| no block is ever closed by a blank line | LANGUAGE.md:136, 150 — BAS-41/BAS-43 |
| exactly one blank line between prelude constructs, never zero and never two | LANGUAGE.md:78 says the count is free between terminated constructs — BAS-16 |
| no `Library` line ever appears | LANGUAGE.md:88 — BAS-22 |
...
a blank line that LANGUAGE.md:88 calls *required* and *closing* does not
